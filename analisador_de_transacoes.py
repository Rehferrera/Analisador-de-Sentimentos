...
def analisar_transacao(lista_transacoes):
    ...
    prompt_sistema = """
    Analise as transações financeiras a seguir e identifique 
    se cada uma delas é uma "Possível Fraude" ou deve ser "Aprovada". 
...
lista_de_transacoes = carrega(r"C:\Users\rehferrera\Desktop\Projeto Open AI 2.0\Projeto OpenIA\dados\transacoes.csv")
